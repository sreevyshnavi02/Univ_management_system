    ...
    if(isset($_POST['submit_option'])){
        if($_POST['upload_marks_radio'] == 'enter_manually'){
            ...
            foreach($get_enrolled_students as $stud_details){
                ...
                echo("<tr><form class='marks_of_each_student' method='post' action = 'upload_marks.php'>");
...
<body>
    <script>
        const update_data = document.getElementById('submit_marks_attendance');

        button.addEventListener('click', function insert_query() {
