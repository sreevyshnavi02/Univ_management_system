...
REPLACE INTO TABLE `univ`.`u_student` CHARACTER SET utf8 FIELDS TERMINATED BY ',' 
LINES TERMINATED BY '\r\n' IGNORE 1 LINES 
...
REPLACE INTO TABLE `univ`.`u_course` CHARACTER SET utf8 FIELDS TERMINATED BY ',' 
...
REPLACE INTO TABLE `univ`.`u_prgm_comp_course` CHARACTER SET LATIN1 
FIELDS TERMINATED BY ',' OPTIONALLY ENCLOSED BY '"' ESCAPED BY '"' 
LINES TERMINATED BY '\r\n' IGNORE 1 LINES (@ColVar0, `course_code`, @ColVar2) 
